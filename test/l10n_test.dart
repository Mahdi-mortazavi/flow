...
void main() {
  ...
  group('L10n and AppLanguage Tests', () {
    ...
    test('L10n translations reflect behavioral science & psychological tone', () {
    ...
    test('L10n digit and date formatting helpers work correctly for fa and en', () {
    ...
    test('AppLanguageController toggles and persists preference via SharedPreferences', () async {
